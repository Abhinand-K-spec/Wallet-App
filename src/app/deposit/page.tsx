        ...
        {successMsg ? (
          ...
          <div className="bg-gray-900 border border-emerald-500/20 rounded-2xl p-8 text-center space-y-6 max-w-xl mx-auto shadow-2xl">
            ...
            <div className="pt-4 border-t border-gray-800 flex flex-col sm:flex-row gap-3 justify-center">
              <button
                onClick={handleReset}
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl text-sm transition-all shadow-lg shadow-indigo-600/20 cursor-pointer"
              >
                Submit Another Deposit
              </button>
              <button
                onClick={() => router.push('/history')}
                className="px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-xl text-sm transition-all border border-gray-700 flex items-center justify-center gap-1.5 cursor-pointer"
              >
            ...
            <div className="lg:col-span-5 bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <div className="w-full bg-gray-950 rounded-xl p-3 flex items-center justify-between border border-gray-800 hover:border-gray-700 transition-all">
                  ...
                  <button
                    ...
                    className="p-2 bg-gray-900 hover:bg-gray-800 rounded-lg text-gray-400 hover:text-white transition-colors shrink-0 disabled:opacity-50 cursor-pointer"
              ...
              {walletAddress !== 'Loading address...' && walletAddress !== 'Error fetching address' && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-xl py-3 transition-all flex items-center justify-center gap-2 text-sm border border-gray-700 hover:border-gray-600 shadow-md cursor-pointer"
                >
            ...
            <div className="lg:col-span-7 bg-gray-900 border border-gray-800 rounded-2xl p-6 sm:p-8 shadow-xl space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl py-3.5 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-base shadow-lg shadow-indigo-600/10 hover:shadow-indigo-600/20 mt-2 cursor-pointer"
                >
                  {submitting ? (
                    <>
